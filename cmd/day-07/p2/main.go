...
func main() {
	...
	var (
		...
		totalUsed   int64 = root.recursiveSize()
		desiredFree int64 = 30000000
		// What we delete much be at least this big
		targetSize int64 = totalUsed - (diskSpace - desiredFree)
	)
